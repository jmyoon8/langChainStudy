...
const parsingJsonDataHandler = async () => {
  ...
  const parsingJSONData = await parser.parse(response);
  console.log(parsingJSONData);
  // { answer: 'Paris', source: 'https://en.wikipedia.org/wiki/Paris' }
};

const zodDataHandler = async () => {
...
export { parsingJsonDataHandler, zodDataHandler };
