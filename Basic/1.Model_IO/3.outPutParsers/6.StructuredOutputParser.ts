...
const StructuredOutputParserWithJson = async () => {
...
*/
  ...
  const structuredOutputParser = await parser.parse(response);
  console.log(structuredOutputParser);
  // { answer: 'Paris', source: 'https://en.wikipedia.org/wiki/Paris' }
};

const StructuredOutputParserWithZod = async () => {
...
export { StructuredOutputParserWithJson, StructuredOutputParserWithZod };
